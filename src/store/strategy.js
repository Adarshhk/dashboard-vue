...
export const strategiesStore = defineStore("strategies", {
    state: () => ({
        res : {
            "status": "success",
    ...
    getters : {
        getAllStrategies : (state) => {
            return state.res.data.strategies
        },

        getJoinedStrategies : (state) => {
            return state.res.data.strategy_joined
        },

        getPlans : (state) => {
            return state.res.data.plans
        }
    }
